    ...
    <main>
      ...
      <section className='flex justify-center px-2 sm:px-0'>
        <div className='relative '>
          <img src="https://images.unsplash.com/photo-1501685532562-aa6846b14a0e?q=80&w=1170&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="home image" className='hidden sm:block h-[90vh] w-[96vw] px-2 py-2 object-cover object-center ' />
